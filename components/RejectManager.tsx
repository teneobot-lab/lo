                   ...
                   {activeTab === 'master' ? (
                       filteredMaster.map(item => (
                           <tr key={item.id} className="hover:bg-slate-50 dark:hover:bg-gray-700 transition-colors">
                               ...
                               <td className="p-6 text-xs text-slate-500 dark:text-gray-400 font-bold">{item.unit2 ? `${item.unit2} (x${item.ratio2})` : '-'}</td>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-[2.5rem] shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col border border-white/10">
                ...
                <div className="p-10 overflow-y-auto flex-1 space-y-8">
                    <div className="grid grid-cols-2 gap-8">
                        <div className="space-y-1.5"><label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block ml-2">Waktu Kejadian</label><input type="date" className="w-full p-4 bg-slate-50 dark:bg-gray-800 border-2 border-transparent focus:border-rose-400 rounded-2xl outline-none dark:text-white dark:[color-scheme:dark]" /></div>
                        <div className="space-y-1.5"><label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block ml-2">Catatan Kerusakan</label><input className="w-full p-4 bg-slate-50 dark:bg-gray-800 border-2 border-transparent focus:border-rose-400 rounded-2xl outline-none dark:text-white" placeholder="Penyebab kerusakan..." /></div>
                    </div>
                </div>
                <div className="p-8 border-t border-slate-50 dark:border-gray-800 flex justify-end gap-4 bg-slate-50 dark:bg-gray-800">
                    ...
                    <button className="px-10 py-3 bg-slate-800 dark:bg-gray-700 text-white font-black rounded-2xl shadow-xl hover:bg-slate-900 dark:hover:bg-gray-600 uppercase tracking-widest active:scale-95 transition-all">Konfirmasi Reject</button>
                </div>
            </div>
        </div>
    );
